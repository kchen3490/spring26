# CMSC389E Project 5 - The Program Counter

Due: **Friday, November 14th, 2025 at 11:59PM** on **[Gradescope](https://www.gradescope.com/courses/1115053/assignments/7074257/)**
...
## Importing Projects
To import the project, you need to download `project5 TEMPLATE.zip`, extract it, and move it into the `saves` folder of your Modrinth installation folder. The easiest way of doing this is the following:

1. Download `project5 TEMPLATE.zip` from this directory
2. Locate your `./Downloads` folder and extract the contents of `project5 TEMPLATE.zip`
3. Locate the `project5` folder INSIDE of the folder you extracted into
4. Use `Ctrl + X` or `Cmd + X` on the `project5` folder to cut it, saving it into your clipboard
...
6. Navigate to the `saves` folder, and use `Ctrl + V` to paste `project5`
7. Finally, click the `Play` button to open Minecraft, go to "Singleplayer", and you should see **project 5** has been successfully imported!


## Submitting Projects
Projects will be submitted and autograded via **Gradescope**. If you are not already in the **Gradescope**, the join code can be found in the syllabus. To submit the project, you will need to locate your `project5` world file, zip it into `project5.zip`, and submit it into the relevant Gradescope assignment. Here's a step-by-step:
...
2. Go to the `saves` folder, right click on `project5`, and compress it to **ZIP File**. 
...
---
### Step 3: Reuse Your 4-Bit Adder from P2

Let's bring back your **4-bit full adder** from Project 2!
...
2. Ensure that the program counter signal connects to the register file write signal. This **synchronizes** the clock from project 4 to the one you have just pasted!
